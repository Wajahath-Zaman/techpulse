...
Responsible for collecting Ars Technica articles from the RSS feed.
...
from .parser import ArsTechnicaParser


class ArsTechnicaScraper(BaseScraper):
    """
    Scraper responsible for collecting and parsing Ars Technica articles.
    """
    ...
    def __init__(self):
        ...
        self.parser = ArsTechnicaParser()
        self.enricher = ArticleEnricher()

    def scrape(self) -> list[Article]:
        """
        Scrape all articles from the Ars Technica RSS feed.

        Returns:
            list[Article]
        """

        self.logger.info("Starting Ars Technica scraper.")
