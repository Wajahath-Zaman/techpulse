...
from scrapers.theverge.parser import TheVergeParser


class TheVergeScraper(BaseScraper):
    """
    Scraper responsible for collecting and parsing The Verge articles.
    """
    ...
    def __init__(self):
        ...
        self.parser = TheVergeParser()
        self.enricher = ArticleEnricher()

    def scrape(self) -> list[Article]:
        """
        Scrape all articles from The Verge.

        Returns:
            List[Article]
        """

        self.logger.info("Starting The Verge scraper.")
